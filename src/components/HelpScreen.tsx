...
const FAQ = [
  ...
  {
    q: 'なぜ iPhone では「ホーム画面に追加」が必要なの？',
    a: 'iPhone・iPad では、Safari のタブで開いている Web サイトに通知を送る仕組みが用意されていません。共有ボタンから「ホーム画面に追加」して、そのアイコンから開いた場合にのみ通知を受け取れます。これは iOS 側の仕様で、アプリ側では変更できません。\n\nAndroid や PC では、ホーム画面に追加しなくても通知を受け取れます。',
  },
  {
    q: '設定した通知をやめたい',
  ...
  {
    q: '週間ダイヤが今日を含む7日間（6日先まで）しか表示されない',
    a: '大学から公表されている運行予定が確実に分かる範囲に限って表示しています。それより先は、実際には長期休暇ダイヤや運休日になる日を「授業日ダイヤ」として誤ってお見せしてしまう可能性があるため、あえて表示していません。先の予定は大学ホームページでご確認ください。',
  },
  {
    q: 'ホーム画面への追加方法は？',
