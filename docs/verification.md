...
- 全時刻表シート: 上端58px開けたシート表示（背後のヘッダーが覗く・角丸）、日付ピル内のダイヤ種別バッジ、グリッドの現在便ハイライト（緑背景＋リング）・過去便・未来便の塗り分け
...
- （廃止）旧・PC/横向き2カラム表示時の帯位置・地図高さ追従の確認項目。2026-09 の3タブ構成への改修でこのレイアウト自体を廃止したため、確認不要になった
